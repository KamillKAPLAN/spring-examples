package com.kkaplan.controller;
...
import com.kkaplan.services.EmployeeService;
...
public class RestEmployeeController {
	...
	public List<Employee> getEmployeeWithParams(@RequestParam(name = "firstName", required = true) String firstName,
	...
	public Employee updateEmployee(@PathVariable(name = "id") int id, @RequestBody UpdateEmployeeRequest request) {
